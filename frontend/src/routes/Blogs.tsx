        ...
        <main className="flex-1 flex flex-col items-center py-8">
          <section className="w-full max-w-5xl">
            ...
            <div className="flex justify-between items-center mb-8 p-6 rounded-lg ">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Welcome back {userName} </h1>
                <p className="text-gray-600 dark:text-gray-300">Here are your blog posts:</p>
              </div>
              <div>
                <Link
                  to="/upload_blogs"
