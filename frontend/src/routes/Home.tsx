      ...
      <main className="flex-1 flex flex-col items-center justify-center">
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container mx-auto px-4 md:px-6 text-center space-y-12">
            ...
            <Link
              to={isLogin === 'true' ? "/blogs" : "/signin"}
              className="inline-block mt-8 px-6 py-3 bg-blue-500 text-white text-lg rounded hover:bg-blue-600 transition-colors duration-200"
            >
